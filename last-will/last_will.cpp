...
int assemble_account_number(int secret_modifier){
    ...
    int zhangs = zhang::bank_number_part(secret_modifier);
    int khans = khan::bank_number_part(secret_modifier);
    int garcias = garcia::bank_number_part(secret_modifier);
    int result = zhangs + khans + garcias;
...
int assemble_code() {
//(blue + red) * (blue + red)
//(blue+blue+blue) * (redSum)

int redSum = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
int blueSum =  + khan::blue::code_fragment() + zhang::blue::code_fragment() + garcia::blue::code_fragment();
